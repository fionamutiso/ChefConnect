      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-8 text-brand">
            <li>
              <a href="#about" className="hover:text-orange-500 transition-colors duration-200 font-medium">
                About
              </a>
            </li>
            <li>
              <a href="#features" className="hover:text-orange-500 transition-colors duration-200 font-medium">
                Features
              </a>
            </li>
            <li>
              <a href="#contact" className="hover:text-orange-500 transition-colors duration-200 font-medium">
                Contact
              </a>
            </li>
          </ul>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button className="bg-orange-500 text-white px-6 py-2 rounded-full hover:bg-orange-700 transition-all duration-300 font-medium shadow-md hover:shadow-lg">
              Get Started
            </button>
          </div>
          ...
          <div className="md:hidden mt-4 bg-white border-t border-gray-200 py-4">
            <ul className="space-y-4">
              ...
              <li className="pt-4 border-t border-gray-200">
                <button className="w-full bg-orange-500 text-white px-6 py-3 rounded-full hover:bg-orange-700 transition-all duration-300 font-medium shadow-md hover:shadow-lg">
                  Get Started
                </button>
              </li>
            </ul>
